...
#ifndef INCLUDE_IMURAWREADER_H_
#define INCLUDE_IMURAWREADER_H_

#include "Reader.h"

class ImuRawReader: public Reader
{
public:
	ImuRawReader(ros::NodeHandle& n);
	virtual void parseLine(const std::string& line, const ros::Time& stamp)
				override;
