...
{
public:
	Reader(ros::NodeHandle& n);

	virtual void parseLine(const std::string& line, const ros::Time& stamp) = 0;

	virtual ~Reader();

protected:
	void tokenize(const std::string& line, const std::string& sepChar, std::vector<std::string>& tokenVec);
