...
#ifndef INCLUDE_COMMANDLINEREADER_H_
#define INCLUDE_COMMANDLINEREADER_H_
...
public:
	...
	std::string getInitialCommand();
	double getFrequency();

	Reader* getReader(ros::NodeHandle& n);
...
#endif /* INCLUDE_COMMANDLINEREADER_H_ */
